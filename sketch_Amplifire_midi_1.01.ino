...
// and act as a wah pedal
// 4 foot switches are supported of the momentary close type and connecting pins 2,3,4,5 to ground
// a 5th footswitch toggles between a high and a low volume
// a pot on pin A0 to input a voltage between 0 and 5V
// a din socket on serial tx pin with a connection to + 5v via a 220 Ohm resistor and a connection to gnd
